class Player {
  ...
  void shoot() {
    ...
    Bullet new_bullet = new Bullet(bullet_position.x + BLOCK_SIZE / 2, bullet_position.y + BLOCK_SIZE / 2, bullet_speed, playerData.attack, bullet_angle, playerData.bulletImage);
